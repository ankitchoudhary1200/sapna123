...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ankitchoudhary1200/sapna123",
)
...
# API KEY - here
API_KEY = getenv("API_KEY", "8bb4b4_mvMkxyU7TggHY12o3FTWPDhNQ3xUGMNX")
...
START_VID_URL = getenv(
    "START_VID_URL", "https://ar-hosting.pages.dev/1757590358035.mp4"
)
PING_IMG_URL = getenv(
